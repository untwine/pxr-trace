...
class PxrTraceConan(ConanFile):
    name = "pxr-trace"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-trace"
    url = "https://github.com/untwine/pxr-trace"
    description = "Performance tracking library used in OpenUSD"
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-trace"]
        self.cpp_info.libs = ["PxrTrace"]
